...
export default function ReservationHero() {
  const features = [
    { icon: Calendar, label: "Easy Booking", color: "var(--red)" },
    { icon: Clock, label: "Flexible Times", color: "#10b981" },
    { icon: Award, label: "Premium Tables", color: "#f59e0b" },
    { icon: Sparkles, label: "Special Events", color: "#8b5cf6" },
  ];
            ...
            {features.map((feature, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs sm:text-sm font-bold whitespace-nowrap" style={{ color: "var(--black)" }}>
                    {feature.label}
                  </p>
                </div>
              );
